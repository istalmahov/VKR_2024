...
class ClassifierResCNNMFCC(nn.Module):
    def __init__(self, number_of_classes: int):
        super(ClassifierResCNNMFCC, self).__init__()
        ...
        self.downsample = nn.Sequential(nn.Conv2d(1, 16, kernel_size=1),
                                        nn.BatchNorm2d(16),
                                        nn.AdaptiveAvgPool2d((3, 10)))
